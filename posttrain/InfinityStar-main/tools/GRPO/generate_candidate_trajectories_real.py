...
def main():
    ...
    default_actionhead_repo_root = os.path.join(default_package_root, "TSformer-VO-main")
    ...
    ap.add_argument("--api_py", type=str, required=True, help="Path to posttrain/infinity_tsformer_api_server.py")
    ap.add_argument("--infinity_server_config", type=str, required=True, help="Path to posttrain/config.json")
    ...
    ap.add_argument(
        ...
        help="Path to actionhead/TSformer-VO-main repo root used by api server.",
    )
