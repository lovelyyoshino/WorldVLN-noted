...
# copies. The open-source layout keeps it directly under this folder.
DEFAULT_INFINITY_REPO_ROOT = REPO / "InfinityStar-main"
...
STAGE2_REPO_ROOT = (ROOT / "TSformer-VO-main").resolve()
_S2_WINDOW_SIZE = 4
...
DEFAULT_ACTIONHEAD_REPO_ROOT = ROOT / "TSformer-VO-main"
